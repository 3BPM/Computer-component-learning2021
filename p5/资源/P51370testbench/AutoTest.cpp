...
bool isAK=1; const int time=1000,pointnum=290;
const char isedir[105]="C:\\Xilinx\\14.7\\ISE_DS\\ISE";
...
//	fprintf(tb,"\t\tclk<=0;\n");
//	fprintf(tb,"\t\treset<=1;\n");
//	fprintf(tb,"\t\t#15 reset <= 0;\n");
//	fprintf(tb,"\tend\n\n");
//	fprintf(tb,"\talways #5 clk<=~clk;\n\n");
//	fprintf(tb,"endmodule");
	FILE* tb2=fopen("mips2.txt","r");
	char s[1000]={};
	while(fgets(s,9999,tb2)!=NULL)
		fputs(s,tb);
	fclose(tb2); 
	fclose(tb); return;
}
